...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			แก้ไขหัวข้อการประเมิน | แบบประเมิน รายงานการฝึกสหกิจ
			<small>แก้ไข-ลบ/แก้ไข ด้านการประเมิน</small>
		</h1>
		<ol class="breadcrumb">
				...
				<div class="col-md-12">
					<div class="box box-warning">
						<div class="box-header with-border">
							<h3 class="box-title">แก้ไขด้านการประเมิน | แบบประเมินรายงานการฝึกสหกิจ</h3>
												...
												<div class="tab-content">
													<div class="tab-pane active" id="tab1">
														...
														<div class="form-group">
															...
															<div class="col-md-7">
																<input type="text" name="topic" class="form-control" placeholder="หัวข้อการประเมินรายงานการฝึกสหกิจ" required value="<?php echo $result["topic"]; ?>" />
															</div>
														</div>
														<div class="form-group">
