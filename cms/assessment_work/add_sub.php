...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			เพิ่มหัวข้อการประเมิน | <?php echo $result["topic"]; ?>
		...
		<ol class="breadcrumb">
			...
			<li><a href="index_sub.php?page=<?php echo $_GET["page"]; ?>&aid=<?php echo $_GET["aid"]; ?>&ass_id=<?php echo $ass_id; ?>"><?php echo $result["topic"]; ?></a></li>
			<li class="active"> เพิ่มหัวข้อการประเมิน</li>
		</ol>
	</section>
	<section class="content">
		<form class="form-horizontal" action="do_add_sub.php?page=<?php echo $_GET["page"]; ?>&aid=<?php echo $_GET["aid"]; ?>" name="form_student" method="POST"  enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-12">
					<div class="box box-warning">
						<div class="box-header with-border">
							<h3 class="box-title">เพิ่มหัวข้อการประเมิน | <?php echo $result["topic"]; ?></h3>
											...
											<div class="form-body">
												<div class="tab-content">
													<div class="tab-pane active" id="tab1">
														<h3 class="block headtext-set-center">แก้ไขหัวข้อการประเมิน</h3>
														<div class="form-group">
															...
															<div class="col-md-7">
																<select name="ass_id" class="form-control">
																	...
																	{
																		?>
																		<option value="<?php echo $resultAssess["id"]; ?>" <?php if($resultAssess["id"] == $ass_id) { echo "selected"; } ?>><?php echo $resultAssess["topic"]; ?></option>
																		<?php
																	}
																	?>
																</select>
														...
														<div class="form-group">
															...
															<div class="col-md-7">
																<input type="text" name="sub_topic" class="form-control" placeholder="" required />
															</div>
														</div>
														<div class="form-group">
															...
															<div class="col-md-7">
																<textarea class="form-control" name="sub_detail"></textarea>
															</div>
														</div>
														<!-- <div class="form-group">
