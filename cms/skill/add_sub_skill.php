...
<div class="content-wrapper">
	<section class="content-header">
		...
		<ol class="breadcrumb">
			...
			<li class="active">เพิ่มความสามารถพิเศษ</li>
		</ol>
	</section>
	<section class="content">
		<form class="form-horizontal" action="do_add_sub_skill.php?page=<?php echo $_GET["page"]; ?>&fid=<?php echo $_GET["fid"]; ?>" name="form_student" method="POST"  enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-12">
					<div class="box box-warning">
						<div class="box-header with-border">
							<h3 class="box-title">เพิ่มความสามารถพิเศษ</h3>
											...
											<div class="form-body">
												<div class="tab-content">
													<div class="tab-pane active" id="tab1">
														<h3 class="block headtext-set-center">เพิ่มความสามารถพิเศษ</h3>
														...
														<div class="form-group">
															...
															<div class="col-md-6">
																<input type="text" class="form-control" name="sub_name" placeholder="กรอกประเภทความสามารถพิเศษ" required />
															</div>
														</div>
													</div>
												</div>
