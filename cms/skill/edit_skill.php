...
<div class="content-wrapper">
	<section class="content-header">
		<h1>
			...
			<small>แก้ไขม-ลบ/แก้ไข ประเภทความสามารถพิเศษ</small>
		</h1>
		<ol class="breadcrumb">
			<li><a href="#"><i class="fa fa-dashboard"></i> หน้าหลัก</a></li>
			<li><a href="index.php?page=<?php echo $_GET["page"]; ?>&fid=<?php echo $_GET["fid"]; ?>"><i></i> จัดการประเภทความสามารถพิเศษ</a></li>
			<li class="active">แก้ไขมประเภทความสามารถพิเศษ</li>
		</ol>
	</section>
	<section class="content">
		<form class="form-horizontal" action="do_edit_skill.php?page=<?php echo $_GET["page"]; ?>&fid=<?php echo $_GET["fid"]; ?>" name="form_student" method="POST"  enctype="multipart/form-data">
			<div class="row">
				<div class="col-md-12">
					<div class="box box-warning">
						<div class="box-header with-border">
							<h3 class="box-title">แก้ไขมประเภทความสามารถพิเศษ</h3>
											...
											<div class="form-body">
												<div class="tab-content">
													<div class="tab-pane active" id="tab1">
														<h3 class="block headtext-set-center">แก้ไขมประเภทความสามารถพิเศษ</h3>
														<div class="form-group">
															<label class="control-label col-md-4">ประเภทความสามารถพิเศษ
																<span class="required"> * </span>
															</label>
															<div class="col-md-6">
																<input type="text" class="form-control" name="skill_name" placeholder="กรอกประเภทความสามารถพิเศษ" required value="<?php echo $result["skill_name"]; ?>" />
															</div>
														</div>
													</div>
												</div>
