...
if(isset($_POST["checkStuEdit"]) and $_POST["checkStuEdit"] == "1")
{
	...
	if(isset($_POST["cloneDataParent"]) and $_POST["cloneDataParent"] == "1")
	{
		$permanent_address = "";
		$permanent_phone = "";
	}
	...
	if(isset($_POST["check_address"]) and $_POST["check_address"] != "")
	{
